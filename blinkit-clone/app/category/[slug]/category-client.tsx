...
export default function CategoryClient({ category: initialCategory }: { category: Category | null }) {
        ...
        const fetchCategoryData = async () => {
            try {
                ...
                if (category || initialCategory) {
                    const currentCat = category || initialCategory
                    // Fetch subcategories
                    ...
                    const categorySubcategories = Array.isArray(allSubcategories) ? allSubcategories.filter(
                        (sub: SubCategory) => sub.categoryId === currentCat?.id,
                    ) : []
